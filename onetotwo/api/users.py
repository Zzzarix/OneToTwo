...
def get_user(uid: str, manager: Annotated[UserManager, get_user_manager]):
    """Get user"""
    ...

@router.post("/create", response_model=User, response_description="Create user")
def create_user(schema: CreateUser, manager: Annotated[UserManager, get_user_manager]):
    """Create user"""
    ...

@router.post("/update", response_description="Update user")
def update_user(schema: UpdateUser, manager: Annotated[UserManager, get_user_manager]):
    """Update user"""
    ...

@router.post("/delete", response_description="Delete user")
def delete_user(schema: DeleteUser, manager: Annotated[UserManager, get_user_manager]):
    """Delete user"""
    ...
